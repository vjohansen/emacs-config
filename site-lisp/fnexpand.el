...
;; Copyright (C) 1991-1996 eirik and trost
...
(defconst fnexpand-version
  "$Id: fnexpand.el,v 1.7 1997/03/20 07:57:47 jaalto NotReleased jaalto $"
...
(defvar fnexpand-passwd-eval-form nil)
...
;;		(setq completion (concat completion " "))))  ;; VJ: remove space
	(delete-region (- (point) (length name)) (point))
	(insert completion)))
