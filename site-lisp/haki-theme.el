...
;;; --- Org mode
   ...
   `(org-block-begin-line                    ((,class  :underline (:line-width (1 . 1) :color ,cursor) :extend t :weight demi-bold :height 0.9 :foreground ,fg-dim)))
   ...
   `(org-upcoming-deadline                   ((,class :foreground ,fg-main :underline ,error)))
...
;;; --- Message
   ...
   `(message-header-name 	((,class :height 0.8)))
...
;;; --- Markdown
   ...
   ;; `(markdown-html-attr-name-face          ((,class :foreground text)))
   ;; `(markdown-html-attr-value-face         ((,class :foreground text)))
   ;; `(markdown-html-entity-face             ((,class :foreground text)))
   ;; `(markdown-html-tag-delimiter-face      ((,class :foreground text)))
   ;; `(markdown-html-tag-name-face           ((,class :foreground text)))
...
;;; --- Meow (meow > evil)
   `(meow-beacon-indicator                   ((,class :height 1.0 :weight ultra-heavy :foreground ,heading-5)))
   `(meow-beacon-cursor                      ((,class :background ,heading-5)))
   `(meow-insert-indicator 	             ((,class :weight ultra-heavy :foreground ,heading-4)))
   `(meow-insert-cursor                      ((,class :background ,heading-4)))
   `(meow-keypad-indicator 	             ((,class :weight ultra-heavy :foreground ,heading-3)))
   `(meow-keypad-cursor                      ((,class :background ,heading-3)))
   `(meow-motion-indicator 	             ((,class :weight ultra-heavy :foreground ,heading-2)))
   `(meow-motion-cursor                      ((,class :background ,heading-2)))
   `(meow-normal-indicator 	             ((,class :weight ultra-heavy :foreground ,title)))
...
;;; --- Avy
   ...
   `(avy-lead-face 		         ((,class :weight heavy :foreground ,fg-main :background ,haki-region)))
